...
public class HtmlUtil {
     ...
     * @return String
     */
    public static String createHtmlData(ZhihuPostDetailBean zhihuPostDetailBean) {
        final String css = HtmlUtil.createCssTag(zhihuPostDetailBean.getCss());
        final String js = HtmlUtil.createJsTag(zhihuPostDetailBean.getJs());
        return createHtmlData(zhihuPostDetailBean.getBody(), css, js);
    }
}
